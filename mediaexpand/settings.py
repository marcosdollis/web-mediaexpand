...
# Database
# SQLite local, PostgreSQL no Railway
...
# WhiteNoise configuration - usar CompressedStaticFilesStorage ao invés de Manifest
# para evitar problemas com arquivos não hasheados
STORAGES = {
    "default": {
